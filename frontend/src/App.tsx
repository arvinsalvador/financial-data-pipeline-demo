...
export default function App() {
  ...
  const [page, setPage] = useState<"sources" | "staging" | "canonical" | "generated" | "messy" | "validation" | "reconciliation" | "governance">("sources");
